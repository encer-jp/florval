...
void main() {
  group('E2E', () {
    ...
    test('generates code from petstore.yaml', () {
      ...
      expect(
          File(p.join(outputDir.path, 'responses', 'list_pets_api_response.dart'))
              .existsSync(),
          isTrue);
      expect(
          File(p.join(outputDir.path, 'responses', 'create_pet_api_response.dart'))
              .existsSync(),
          isTrue);
      expect(
          File(p.join(outputDir.path, 'responses', 'get_pet_api_response.dart'))
              .existsSync(),
          isTrue);
      expect(
          File(p.join(outputDir.path, 'responses', 'update_pet_api_response.dart'))
              .existsSync(),
          isTrue);
      expect(
          File(p.join(outputDir.path, 'responses', 'delete_pet_api_response.dart'))
              .existsSync(),
          isTrue);
      expect(
          File(p.join(
                  outputDir.path, 'responses', 'upload_pet_photo_api_response.dart'))
              .existsSync(),
          isTrue);
    ...
    test('generated responses contain sealed class syntax', () {
      ...
      expect(responseCode, contains('sealed class GetPetApiResponse'));
      expect(responseCode,
          contains('const factory GetPetApiResponse.success(Pet data)'));
      expect(responseCode,
          contains('const factory GetPetApiResponse.notFound()'));
      expect(responseCode,
          contains('const factory GetPetApiResponse.serverError(Error data)'));
      expect(responseCode, contains('const factory GetPetApiResponse.unknown('));
    });
    ...
    test('generated client contains dio calls with status code switching', () {
      ...
      expect(clientCode, contains('Future<ListPetsApiResponse> listPets('));
      expect(clientCode, contains('Future<GetPetApiResponse> getPet('));
      expect(clientCode, contains('Future<CreatePetApiResponse> createPet('));
      expect(clientCode, contains('Future<DeletePetApiResponse> deletePet('));
      ...
      expect(clientCode,
          contains('Future<UploadPetPhotoApiResponse> uploadPetPhoto('));
    ...
    test('generated providers contain correct riverpod syntax', () {
      ...
      expect(providerCode, contains('final createPetMutation = Mutation<CreatePetApiResponse>();'));
      expect(providerCode, contains('final updatePetMutation = Mutation<UpdatePetApiResponse>();'));
      expect(providerCode, contains('final deletePetMutation = Mutation<DeletePetApiResponse>();'));
      ...
      expect(providerCode,
          contains('final uploadPetPhotoMutation = Mutation<UploadPetPhotoApiResponse>();'));
