...
class ProviderGenerator {
  ...
  void _writeImports(
    ...
    // Import centralized Dio provider
    buffer.writeln("import 'api_dio_provider.dart';");
  ...
  /// Generates the centralized Dio provider file content.
  ///
  /// This provider is overridden once by the user with their Dio instance,
  /// and all per-tag client providers consume it automatically.
  String generateApiDioProvider() {
    final buffer = StringBuffer();
    ...
    buffer.writeln(
        "import 'package:riverpod_annotation/riverpod_annotation.dart';");
    buffer.writeln();
    buffer.writeln("part 'api_dio_provider.g.dart';");
    buffer.writeln();
    buffer.writeln('@riverpod');
    buffer.writeln('Dio apiDio(Ref ref) {');
    buffer.writeln(
  ...
  void _writeClientProvider(StringBuffer buffer, String tag) {
    ...
    buffer.writeln('  return $className(ref.watch(apiDioProvider));');
    buffer.writeln('}');
  }
