...
void main() {
  group('ProviderGenerator', () {
    ...
    test('generates GET endpoint as @riverpod Notifier', () {
      ...
      expect(code, contains('FutureOr<r.GetUserResponse> build('));
    ...
    test('generates PUT endpoint as Mutation constant with path params', () {
      ...
      expect(code, contains('final updateUserMutation = Mutation<r.UpdateUserResponse>();'));
    ...
    test('generates DELETE endpoint as Mutation constant', () {
      ...
      expect(code, contains('final deleteUserMutation = Mutation<r.DeleteUserResponse>();'));
    ...
    test('generates multipart mutation as Mutation constant', () {
      ...
      expect(code, contains('final uploadPetPhotoMutation = Mutation<r.UploadPetPhotoResponse>();'));
    ...
    group('pagination', () {
      ...
      test('paginated provider build() switches on Union type', () {
        ...
        expect(code, contains('case r.ListPetsPaginatedResponseSuccess(:final data):'));
    ...
    group('retry', () {
      ...
      test('Mutation constants are not affected by retry', () {
        ...
        final mutationLine = code.split('\n')
            .where((l) => l.contains('Mutation<r.CreateUserResponse>'))
            .first;
