...
void main() {
  group('EndpointAnalyzer', () {
    ...
    test('extracts all endpoints', () {
      ...
      // GET /pets, POST /pets, GET /pets/paginated, POST /pets/{petId}/photo, POST /pets/{petId}/photos, PATCH /pets/{petId}/details, GET /pets/{petId}, PUT /pets/{petId}, DELETE /pets/{petId}
