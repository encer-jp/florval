...
void main() {
  group('ProviderGenerator', () {
    ...
    test('generates response imports', () {
      ...
      expect(code,
          contains("import '../responses/get_user_api_response.dart';"));
    });
    ...
    test('generates GET endpoint as @riverpod Notifier', () {
      ...
      expect(code, contains('FutureOr<GetUserApiResponse> build('));
    ...
    test('generates GET endpoint without params', () {
      ...
      expect(code, contains('FutureOr<ListUsersApiResponse> build() async'));
    ...
    test('generates POST endpoint as Mutation constant', () {
      ...
      expect(code, contains('final createUserMutation = Mutation<CreateUserApiResponse>();'));
    ...
    test('generates PUT endpoint as Mutation constant with path params', () {
      ...
      expect(code, contains('final updateUserMutation = Mutation<UpdateUserApiResponse>();'));
    ...
    test('generates DELETE endpoint as Mutation constant', () {
      ...
      expect(code, contains('final deleteUserMutation = Mutation<DeleteUserApiResponse>();'));
    ...
    test('mutation generates helper without invalidation when autoInvalidate is true but no GET endpoints', () {
      ...
      expect(code, contains('Future<CreateUserApiResponse> createUser('));
    ...
    test('mutation does not generate helper by default', () {
      ...
      expect(code, isNot(contains('Future<CreateUserApiResponse> createUser(')));
    ...
    test('generates multipart mutation as Mutation constant', () {
      ...
      expect(code, contains('final uploadPetPhotoMutation = Mutation<UploadPetPhotoApiResponse>();'));
    ...
    group('pagination', () {
      ...
      test('paginated provider build() switches on Union type', () {
        ...
        expect(code, contains('case ListPetsPaginatedApiResponseSuccess(:final data):'));
    ...
    group('retry', () {
      ...
      test('Mutation constants are not affected by retry', () {
        ...
        final mutationLine = code.split('\n')
            .where((l) => l.contains('Mutation<CreateUserApiResponse>'))
            .first;
