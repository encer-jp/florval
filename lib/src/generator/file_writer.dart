...
class FileWriter {
  ...
  void writeBarrel(
    ...
    // api.dart (backward-compatible re-export)
    final buffer = StringBuffer();
    buffer.writeln('// Generated by florval. Do not edit.');
    buffer.writeln('//');
    buffer.writeln(
        '// If you encounter name collisions, import the specific');
    buffer.writeln(
        '// barrel file instead: api_models.dart, api_responses.dart, etc.');
    buffer.writeln();
    buffer.writeln("export 'api_models.dart';");
    buffer.writeln("export 'api_responses.dart';");
